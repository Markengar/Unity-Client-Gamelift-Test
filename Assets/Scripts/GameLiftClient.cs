...
public class GameLiftClient
{
   ...
   private string CognitoIdentityPool = "";//Removed that , because the repository is public .
    private string FleetId = "fleet-e2451bd2-6e73-43b1-aada-36a1022f6251";
    ...
    // TODO: probably don't hardcode this, use alias or something
   ...
   private void CreateGameLiftClient()
   {
      ...
      else
      {
         ...
         AmazonGameLiftConfig amazonGameLiftConfig = new AmazonGameLiftConfig()
         {
            ...
            _amazonGameLiftClient = new AmazonGameLiftClient("", "", amazonGameLiftConfig);
            
            Debug.Log("TestingMode");
        }
        */
   }
